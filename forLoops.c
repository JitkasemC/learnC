// For loops in C are straightforward. They supply the ability to create a loop - a code block that runs multiple times. F
// or loops require an iterator variable, usually notated as i.
...
// the result should be "10! is 3628800."
